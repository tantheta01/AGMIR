...
export const NavLink = tw.a`
  text-lg my-2 lg:text-sm lg:mx-6 lg:my-0 text-blue-500
...
export const LogoLink = styled(NavLink)`
  ${tw`flex items-center text-green-400 font-black border-b-0 text-2xl! ml-0!`};
...
export default ({ roundedHeaderButton = false, logoLink, links, className, collapseBreakpointClass = "lg" }) => {
  ...
  const defaultLinks = [
    <NavLinks key={1}>
      <PrimaryLink css={roundedHeaderButton && tw`rounded-full`} onClick={Confirm}>Log Out</PrimaryLink>
    </NavLinks>
  ]; 
